...
FT_LOCAL_DEF(void) FTC_INode_Free(FTC_INode inode, FTC_Cache cache)
{
...
FT_LOCAL_DEF(FT_Error) FTC_INode_New(FTC_INode * pinode, FTC_GQuery gquery, FTC_Cache cache)
{
	FT_Memory memory = cache->memory;
	FT_Error error;
...
FT_LOCAL_DEF(FT_ULong) ftc_inode_weight(FTC_Node ftcinode, FTC_Cache ftccache)
{
	FTC_INode inode = (FTC_INode) ftcinode;
	FT_Offset size = 0;
