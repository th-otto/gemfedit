...
FT_LOCAL(FT_Long) cff_parse_num(CFF_Parser parser, FT_Byte ** d);

FT_LOCAL(FT_Error) cff_parser_init(CFF_Parser parser,
	FT_UInt code,
...
FT_LOCAL(FT_Error) cff_parser_run(CFF_Parser parser, FT_Byte * start, FT_Byte * limit);
