...
/* `error').                                               */
FT_LOCAL_DEF(CF2_Stack) cf2_stack_init(FT_Memory memory, FT_Error * e, FT_UInt stackSize)
{
...
FT_LOCAL_DEF(void) cf2_stack_pushInt(CF2_Stack stack, CF2_Int val)
{
...
FT_LOCAL_DEF(void) cf2_stack_pushFixed(CF2_Stack stack, CF2_Fixed val)
{
	if (stack->top == stack->buffer + stack->stackSize)
	{
		CF2_SET_ERROR(stack->error, Stack_Overflow);
...
/* Note: type mismatch is silently cast */
/* TODO: check this                     */
FT_LOCAL_DEF(CF2_Fixed) cf2_stack_getReal(CF2_Stack stack, CF2_UInt idx)
{
...
FT_LOCAL_DEF(void) cf2_stack_setReal(CF2_Stack stack, CF2_UInt idx, CF2_Fixed val)
{
	if (idx > cf2_stack_count(stack))
	{
		CF2_SET_ERROR(stack->error, Stack_Overflow);
...
FT_LOCAL_DEF(void) cf2_stack_pop(CF2_Stack stack, CF2_UInt num)
{
...
FT_LOCAL_DEF(void) cf2_stack_roll(CF2_Stack stack, CF2_Int count, CF2_Int shift)
{
