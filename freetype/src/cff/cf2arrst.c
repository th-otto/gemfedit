...
FT_LOCAL_DEF(void) cf2_arrstack_init(CF2_ArrStack arrstack, FT_Memory memory, FT_Error * error, size_t sizeItem)
{
	FT_ASSERT(arrstack);
...
FT_LOCAL_DEF(void) cf2_arrstack_setCount(CF2_ArrStack arrstack, size_t numElements)
{
	FT_ASSERT(arrstack);
...
FT_LOCAL_DEF(void *) cf2_arrstack_getPointer(const CF2_ArrStack arrstack, size_t idx)
{
	void *newPtr;
...
FT_LOCAL_DEF(void) cf2_arrstack_push(CF2_ArrStack arrstack, const void *ptr)
{
	FT_ASSERT(arrstack);
