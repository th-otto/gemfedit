...
FT_CALLBACK_DEF(FT_Error) cff_cmap_encoding_init(FT_CMap cmap_, FT_Pointer pointer)
{
...
FT_CALLBACK_DEF(void) cff_cmap_encoding_done(FT_CMap cmap_)
{
	CFF_CMapStd cmap = (CFF_CMapStd) cmap_;
...
FT_CALLBACK_DEF(FT_UInt32) cff_cmap_encoding_char_index(FT_CMap cmap_, FT_UInt32 char_code)
{
	CFF_CMapStd cmap = (CFF_CMapStd) cmap_;
	FT_UInt result = 0;
...
FT_CALLBACK_DEF(FT_UInt32) cff_cmap_encoding_char_next(FT_CMap cmap_, FT_UInt32 * pchar_code)
{
	CFF_CMapStd cmap = (CFF_CMapStd) cmap_;
	FT_UInt result = 0;
...
FT_CALLBACK_DEF(const char *) cff_sid_to_glyph_name(FT_Pointer data, FT_UInt32 idx)
{
	TT_Face face = data;
	CFF_Font cff = (CFF_Font) face->extra.data;
...
FT_CALLBACK_DEF(FT_Error) cff_cmap_unicode_init(FT_CMap cmap_, FT_Pointer pointer)
{
...
FT_CALLBACK_DEF(void) cff_cmap_unicode_done(FT_CMap cmap_)
{
	PS_Unicodes unicodes = (PS_Unicodes) cmap_;
...
FT_CALLBACK_DEF(FT_UInt32) cff_cmap_unicode_char_index(FT_CMap cmap_, FT_UInt32 char_code)
{
	PS_Unicodes unicodes = (PS_Unicodes) cmap_;
	TT_Face face = (TT_Face) FT_CMAP_FACE(unicodes);
	CFF_Font cff = (CFF_Font) face->extra.data;
...
FT_CALLBACK_DEF(FT_UInt32) cff_cmap_unicode_char_next(FT_CMap cmap_, FT_UInt32 * pchar_code)
{
	PS_Unicodes unicodes = (PS_Unicodes) cmap_;
	TT_Face face = (TT_Face) FT_CMAP_FACE(unicodes);
	CFF_Font cff = (CFF_Font) face->extra.data;
