...
static FT_Error t42_parse_encoding(FT_Face face_, void *loader_)
{
	...
	if (ft_isdigit(*cur) || *cur == '[')
	{
		...
		for (n = 0; n < count; n++)
		{
			static char const notdef[] = ".notdef";

			T1_Add_Table(char_table, n, notdef, (FT_UInt)sizeof(notdef));
		}
...
FT_LOCAL_DEF(FT_Error) t42_parse_dict(T42_Face face, T42_Loader loader, FT_Byte * base, FT_Long size)
{
	T42_Parser parser = &loader->parser;
	FT_Byte *limit;
