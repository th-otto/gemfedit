...
static FT_Error t42_get_glyph_name(FT_Face face_, FT_UInt32 glyph_index, FT_Pointer buffer, FT_UInt buffer_max)
{
...
static const FT_Service_GlyphDictRec t42_service_glyph_dict = {
	t42_get_glyph_name,					/* get_name   */
	t42_get_name_index					/* name_index */
};
...
static const char *t42_get_ps_font_name(FT_Face face_)
{
	T42_Face face = (T42_Face) face_;
...
FT_CALLBACK_DEF(FT_Module_Interface) T42_Get_Interface(FT_Module module, const FT_String * t42_interface)
{
	FT_UNUSED(module);
