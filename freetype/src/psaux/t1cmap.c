...
#include "psauxerr.h"
  ...
  t1_cmap_std_done( FT_CMap  ft_cmap )
  {
  ...
  t1_cmap_standard_init( FT_CMap  ft_cmap,
                         FT_Pointer  pointer )
  {
    T1_CMapStd cmap = (T1_CMapStd) ft_cmap;
    FT_UNUSED( pointer );
  ...
  FT_CALLBACK_DEF( FT_Error )
  t1_cmap_expert_init( FT_CMap  ft_cmap,
                       FT_Pointer  pointer )
  {
    T1_CMapStd cmap = (T1_CMapStd) ft_cmap;
    FT_UNUSED( pointer );
  ...
  FT_CALLBACK_DEF( FT_Error )
  t1_cmap_custom_init( FT_CMap  ft_cmap,
                       FT_Pointer     pointer )
  {
  ...
  FT_CALLBACK_DEF( void )
  t1_cmap_custom_done( FT_CMap ft_cmap )
  {
    T1_CMapCustom cmap = (T1_CMapCustom) ft_cmap;
    cmap->indices = NULL;
    cmap->first   = 0;
  ...
  FT_CALLBACK_DEF( FT_Error )
  t1_cmap_unicode_init( FT_CMap ft_cmap, FT_Pointer pointer )
  {
  ...
  FT_CALLBACK_DEF( void )
  t1_cmap_unicode_done( FT_CMap ft_cmap )
  {
    PS_Unicodes  unicodes = (PS_Unicodes) ft_cmap;
