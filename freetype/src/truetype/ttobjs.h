...
FT_LOCAL(FT_Error) tt_glyphzone_new(FT_Memory memory, FT_UShort maxPoints, FT_Short maxContours, TT_GlyphZone zone);
...
/* Face functions                                                        */
/*                                                                       */
FT_LOCAL(FT_Error) tt_face_init(FT_Stream stream, FT_Face ttface, FT_Int face_index, FT_Int num_params, FT_Parameter * params);

FT_LOCAL(void) tt_face_done(FT_Face ttface);
...
/* Size functions                                                        */
/*                                                                       */
FT_LOCAL(FT_Error) tt_size_init(FT_Size ttsize);

FT_LOCAL(void) tt_size_done(FT_Size ttsize);

#ifdef TT_USE_BYTECODE_INTERPRETER

FT_LOCAL(FT_Error) tt_size_run_fpgm(TT_Size size, FT_Bool pedantic);

FT_LOCAL(FT_Error) tt_size_run_prep(TT_Size size, FT_Bool pedantic);

FT_LOCAL(FT_Error) tt_size_ready_bytecode(TT_Size size, FT_Bool pedantic);

#endif /* TT_USE_BYTECODE_INTERPRETER */

FT_LOCAL(FT_Error) tt_size_reset(TT_Size size, FT_Bool only_height);
