...
/*    tables.                                                            */
/*                                                                       */
#define GX_TI_EMBEDDED_TUPLE_COORD  0x8000
#define GX_TI_INTERMEDIATE_TUPLE    0x4000
#define GX_TI_PRIVATE_POINT_NUMBERS 0x2000
#define GX_TI_RESERVED_TUPLE_FLAG   0x1000
#define GX_TI_TUPLE_INDEX_MASK      0x0FFF
...
FT_LOCAL(FT_Error) TT_Set_MM_Blend(FT_Face face, FT_UInt num_coords, FT_Fixed * coords);

FT_LOCAL(FT_Error) TT_Get_MM_Blend(FT_Face face, FT_UInt num_coords, FT_Fixed * coords);

FT_LOCAL(FT_Error) TT_Set_Var_Design(FT_Face face, FT_UInt num_coords, FT_Fixed * coords);

FT_LOCAL(FT_Error) TT_Get_MM_Var(FT_Face face, FT_MM_Var * *master);

FT_LOCAL(FT_Error) TT_Get_Var_Design(FT_Face face, FT_UInt num_coords, FT_Fixed * coords);

FT_LOCAL(FT_Error) tt_face_vary_cvt(TT_Face face, FT_Stream stream);


FT_LOCAL(FT_Error) TT_Vary_Apply_Glyph_Deltas(TT_Face face, FT_UInt32 glyph_index, FT_Outline * outline, FT_UInt n_points);

FT_LOCAL(FT_Error) tt_hadvance_adjust(FT_Face face, FT_UInt gindex, FT_Int * adelta);

FT_LOCAL(FT_Error) tt_vadvance_adjust(FT_Face face, FT_UInt gindex, FT_Int * adelta);

FT_LOCAL(void) tt_apply_mvar(FT_Face face);

FT_LOCAL(FT_Error) tt_get_var_blend(FT_Face face, FT_UInt * num_coords, FT_Fixed * *coords, FT_Fixed * *normalizedcoords, FT_MM_Var * *mm_var);

FT_LOCAL(void) tt_done_blend(FT_Face face);
