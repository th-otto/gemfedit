...
static SPH_Font_Class const FAMILY_CLASS_Rules[FAMILY_CLASS_RULES_SIZE] = {
	{"MS Legacy Fonts",
	 {"Aharoni",
	  "Andale Mono",
	  "Andalus",
...
static SPH_Font_Class const STYLE_CLASS_Rules[STYLE_CLASS_RULES_SIZE] = {
	{"Regular Class",
	 {"Regular",
	  "Book",
	  "Medium",
...
static SPH_TweakRule const COMPATIBILITY_MODE_Rules[COMPATIBILITY_MODE_RULES_SIZE] = {
	{"Verdana Clones", 0, "", 0},
};
...
static SPH_TweakRule const PIXEL_HINTING_Rules[PIXEL_HINTING_RULES_SIZE] = {
...
static SPH_TweakRule const DO_SHPIX_Rules[DO_SHPIX_RULES_SIZE] = {
	{"-", 0, "", 0},
};
...
static SPH_TweakRule const SKIP_NONPIXEL_Y_MOVES_Rules[SKIP_NONPIXEL_Y_MOVES_RULES_SIZE] = {
	/* fix vwxyz thinness */
	{"Consolas", 0, "", 0},
...
static SPH_TweakRule const SKIP_NONPIXEL_Y_MOVES_Rules_Exceptions[SKIP_NONPIXEL_Y_MOVES_RULES_EXCEPTIONS_SIZE] = {
	/* Fixes < and > */
...
static SPH_TweakRule const SKIP_NONPIXEL_Y_MOVES_DELTAP_Rules[SKIP_NONPIXEL_Y_MOVES_DELTAP_RULES_SIZE] = {
...
static SPH_TweakRule const SKIP_OFFPIXEL_Y_MOVES_Rules[SKIP_OFFPIXEL_Y_MOVES_RULES_SIZE] = {
	{"-", 0, "", 0},
};
...
static SPH_TweakRule const ROUND_NONPIXEL_Y_MOVES_Rules[ROUND_NONPIXEL_Y_MOVES_RULES_SIZE] = {
...
static SPH_TweakRule const ROUND_NONPIXEL_Y_MOVES_Rules_Exceptions[ROUND_NONPIXEL_Y_MOVES_RULES_EXCEPTIONS_SIZE] = {
	{"-", 0, "", 0},
};
...
static SPH_TweakRule const ALLOW_X_DMOVE_Rules[ALLOW_X_DMOVE_RULES_SIZE] = {
...
static SPH_TweakRule const RASTERIZER_35_Rules[RASTERIZER_35_RULES_SIZE] = {
...
static SPH_TweakRule const NORMAL_ROUND_Rules[NORMAL_ROUND_RULES_SIZE] = {
...
static SPH_TweakRule const SKIP_IUP_Rules[SKIP_IUP_RULES_SIZE] = {
	{"Arial", 13, "Regular", 'a'},
};
...
static SPH_TweakRule const MIAP_HACK_Rules[MIAP_HACK_RULES_SIZE] = {
	{"Geneva", 12, "", 0},
};
...
static SPH_TweakRule const ALWAYS_SKIP_DELTAP_Rules[ALWAYS_SKIP_DELTAP_RULES_SIZE] = {
	{"Georgia", 0, "Regular", 'k'},
...
static SPH_TweakRule const ALWAYS_DO_DELTAP_Rules[ALWAYS_DO_DELTAP_RULES_SIZE] = {
	{"-", 0, "", 0},
};
...
static SPH_TweakRule const NO_ALIGNRP_AFTER_IUP_Rules[NO_ALIGNRP_AFTER_IUP_RULES_SIZE] = {
...
static SPH_TweakRule const NO_DELTAP_AFTER_IUP_Rules[NO_DELTAP_AFTER_IUP_RULES_SIZE] = {
	{"-", 0, "", 0},
};
...
static SPH_TweakRule const NO_CALL_AFTER_IUP_Rules[NO_CALL_AFTER_IUP_RULES_SIZE] = {
	/* Prevent creation of dents in outline */
	{"-", 0, "", 0},
};
...
static SPH_TweakRule const DEEMBOLDEN_Rules[DEEMBOLDEN_RULES_SIZE] = {
...
static SPH_TweakRule const EMBOLDEN_Rules[EMBOLDEN_RULES_SIZE] = {
	{"Courier New", 0, "Regular", 0},
...
static SPH_TweakRule const TIMES_NEW_ROMAN_HACK_Rules[TIMES_NEW_ROMAN_HACK_RULES_SIZE] = {
...
static SPH_TweakRule const COURIER_NEW_2_HACK_Rules[COURIER_NEW_2_HACK_RULES_SIZE] = {
...
static SPH_TweakRule const COMPATIBLE_WIDTHS_Rules[COMPATIBLE_WIDTHS_RULES_SIZE] = {
...
static SPH_ScaleRule const X_SCALING_Rules[X_SCALING_RULES_SIZE] = {
...
FT_LOCAL_DEF(FT_Bool) sph_test_tweak(TT_Face face,
	const FT_String * family,
	FT_UInt ppem,
	const FT_String * style, FT_UInt32 glyph_index, const SPH_TweakRule * rule, FT_UInt num_rules)
{
	FT_UInt i;
...
static FT_UInt scale_test_tweak(TT_Face face,
	const FT_String * family,
	FT_UInt ppem,
	const FT_String * style, FT_UInt32 glyph_index, const SPH_ScaleRule * rule, FT_UInt num_rules)
{
	FT_UInt i;
...
FT_LOCAL_DEF(FT_UInt) sph_test_tweak_x_scaling(TT_Face face,
	const FT_String * family, FT_UInt ppem, const FT_String * style, FT_UInt32 glyph_index)
{
...
FT_LOCAL_DEF(void) sph_set_tweaks(TT_Loader loader, FT_UInt32 glyph_index)
{
	...
	if (loader->exec->sph_tweak_flags & SPH_TWEAK_RASTERIZER_35)
	{
		if (loader->exec->rasterizer_version != TT_INTERPRETER_VERSION_35)
		{
			...
			tt_size_ready_bytecode(loader->exec->size, (loader->load_flags & FT_LOAD_PEDANTIC) != 0);
		} else
		{
			loader->exec->rasterizer_version = TT_INTERPRETER_VERSION_35;
		}
...
#endif /* !(TT_USE_BYTECODE_INTERPRETER && TT_SUPPORT_SUBPIXEL_HINTING_INFINALITY) */
