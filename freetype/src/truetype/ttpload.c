...
/*                                                                       */
FT_LOCAL_DEF(FT_Error) tt_face_load_loca(TT_Face face, FT_Stream stream)
{
	FT_Error error;
	FT_ULong table_len;
	FT_Int shift;
...
FT_LOCAL_DEF(FT_ULong) tt_face_get_location(FT_Face face_, FT_UInt32 gindex, FT_ULong * asize)
{
...
/*    FreeType error code.  0 means success.                             */
/*                                                                       */
FT_LOCAL_DEF(FT_Error) tt_face_load_cvt(TT_Face face, FT_Stream stream)
{
...
/*    FreeType error code.  0 means success.                             */
/*                                                                       */
FT_LOCAL_DEF(FT_Error) tt_face_load_fpgm(TT_Face face, FT_Stream stream)
{
#ifdef TT_USE_BYTECODE_INTERPRETER
...
/*    FreeType error code.  0 means success.                             */
/*                                                                       */
FT_LOCAL_DEF(FT_Error) tt_face_load_prep(TT_Face face, FT_Stream stream)
{
#ifdef TT_USE_BYTECODE_INTERPRETER
...
FT_LOCAL_DEF(FT_Error) tt_face_load_hdmx(TT_Face face, FT_Stream stream)
{
	FT_Error error;
	FT_Memory memory = stream->memory;
...
/*                                                                       */
FT_LOCAL_DEF(FT_Byte *) tt_face_get_device_metrics(TT_Face face, FT_UInt ppem, FT_UInt32 gindex)
{
	FT_UInt nn;
	FT_Byte *result = NULL;
