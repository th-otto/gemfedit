...
FT_CALLBACK_DEF(int) compare_uni_maps(const void *a, const void *b)
{
...
static void ps_check_extra_glyph_name(const char *gname, FT_UInt32 glyph, FT_UInt32 * extra_glyphs, FT_UInt * states)
{
	FT_UInt n;
...
static FT_UInt32 ps_unicodes_char_index(PS_Unicodes table, FT_UInt32 unicode)
{
	PS_UniMap *min;
	PS_UniMap *max;
	PS_UniMap *mid;
