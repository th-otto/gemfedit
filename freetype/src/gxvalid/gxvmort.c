 ...
 */
FT_LOCAL_DEF(void) gxv_mort_featurearray_validate(FT_Bytes table, FT_Bytes limit, FT_ULong nFeatureFlags, GXV_Validator gxvalid)
{
	FT_Bytes p = table;
	FT_ULong i;
...
FT_LOCAL_DEF(void) gxv_mort_coverage_validate(FT_UShort coverage, GXV_Validator gxvalid)
{
	FT_UNUSED(coverage);
	FT_UNUSED(gxvalid);
...
FT_LOCAL_DEF(void) gxv_mort_validate(FT_Bytes table, FT_Face face, FT_Validator ftvalid)
{
