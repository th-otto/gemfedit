...
FT_CALLBACK_DEF(FT_Error) pfr_get_kerning(FT_Face pfrface, FT_UInt left, FT_UInt right, FT_Vector * avector)
{
 ...
 *  PFR METRICS SERVICE
 */
FT_CALLBACK_DEF(FT_Error) pfr_get_advance(FT_Face pfrface, FT_UInt gindex, FT_Pos * anadvance)
{
	PFR_Face face = (PFR_Face) pfrface;
...
FT_CALLBACK_DEF(FT_Error) pfr_get_metrics(FT_Face pfrface,
...
FT_CALLBACK_DEF(FT_Module_Interface) pfr_get_service(FT_Module module, const FT_String * service_id)
{
	FT_UNUSED(module);
