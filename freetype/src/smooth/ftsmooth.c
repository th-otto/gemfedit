...
static FT_Error ft_smooth_init(FT_Module render_)
{
...
static FT_Error ft_smooth_render_generic(FT_Renderer render,
	FT_GlyphSlot slot, FT_Render_Mode mode, const FT_Vector * origin, FT_Render_Mode required_mode)
{
	FT_Error error;
	 ...
	 */
	if (x_left > FT_INT_MAX || y_top > FT_INT_MAX || x_left < FT_INT_MIN || y_top < FT_INT_MIN)
	{
...
static FT_Error
ft_smooth_render_lcd(FT_Renderer render, FT_GlyphSlot slot, FT_Render_Mode mode, const FT_Vector * origin)
{
	FT_Error error;

	error = ft_smooth_render_generic(render, slot, mode, origin, FT_RENDER_MODE_LCD);
	if (!error)
...
static FT_Error
ft_smooth_render_lcd_v(FT_Renderer render, FT_GlyphSlot slot, FT_Render_Mode mode, const FT_Vector * origin)
{
	FT_Error error;

	error = ft_smooth_render_generic(render, slot, mode, origin, FT_RENDER_MODE_LCD_V);
	if (!error)
...
FT_CALLBACK_TABLE_DEF const FT_Renderer_Class ft_smooth_renderer_class = {
	{
		FT_MODULE_RENDERER,
	...
	FT_GLYPH_FORMAT_OUTLINE, ft_smooth_render,	/* render_glyph    */
	ft_smooth_transform,	/* transform_glyph */
	ft_smooth_get_cbox,	/* get_glyph_cbox  */
	ft_smooth_set_mode,	/* set_mode        */
	&ft_grays_raster	/* raster_class    */
};

FT_CALLBACK_TABLE_DEF const FT_Renderer_Class ft_smooth_lcd_renderer_class = {
	{
		FT_MODULE_RENDERER,
		sizeof(FT_RendererRec),
		"smooth-lcd",
	...
	FT_GLYPH_FORMAT_OUTLINE, ft_smooth_render_lcd,	/* render_glyph    */
	ft_smooth_transform,	/* transform_glyph */
	ft_smooth_get_cbox,	/* get_glyph_cbox  */
	ft_smooth_set_mode,	/* set_mode        */
	&ft_grays_raster	/* raster_class    */
...
FT_CALLBACK_TABLE_DEF const FT_Renderer_Class ft_smooth_lcdv_renderer_class = {
	{
		FT_MODULE_RENDERER,
		sizeof(FT_RendererRec),
		"smooth-lcdv",
	...
	FT_GLYPH_FORMAT_OUTLINE, ft_smooth_render_lcd_v,	/* render_glyph    */
	ft_smooth_transform,	/* transform_glyph */
	ft_smooth_get_cbox,	/* get_glyph_cbox  */
	ft_smooth_set_mode,	/* set_mode        */
	&ft_grays_raster	/* raster_class    */
