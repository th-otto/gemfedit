...
/*                                                                       */
FT_LOCAL_DEF(FT_Error) tt_face_load_hmtx(TT_Face face, FT_Stream stream, FT_Bool vertical)
{
	FT_Error error;
...
/*    FreeType error code.  0 means success.                             */
/*                                                                       */
FT_LOCAL_DEF(FT_Error) tt_face_load_hhea(TT_Face face, FT_Stream stream, FT_Bool vertical)
{
	FT_Error error;
...
/*                the `vertical' flag.                                   */
/*                                                                       */
FT_LOCAL_DEF(void) tt_face_get_metrics(TT_Face face, FT_Bool vertical, FT_UInt32 gindex, FT_Short *abearing, FT_UShort *aadvance)
{
	FT_Error error;
