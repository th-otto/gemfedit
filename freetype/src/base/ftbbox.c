...
/*                                                                       */
static int BBox_Move_To(const FT_Vector * to, void *user_)
{
...
/*    Always 0.  Needed for the interface only.                          */
/*                                                                       */
static int BBox_Line_To(const FT_Vector * to, void * user_)
{
	TBBox_Rec * user = (TBBox_Rec *)user_;
	user->last = *to;
...
/*                                                                       */
static int BBox_Conic_To(const FT_Vector *control, const FT_Vector *to, void *user_)
{
	TBBox_Rec * user = (TBBox_Rec *)user_;
...
/*                                                                       */
static int BBox_Cubic_To(const FT_Vector *control1, const FT_Vector *control2, const FT_Vector *to, void *user_)
{
	TBBox_Rec * user = (TBBox_Rec *)user_;
