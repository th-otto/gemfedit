...
/*                                                                       */
FT_CALLBACK_DEF(void *) ft_alloc(FT_Memory memory, FT_Offset size)
{
	FT_UNUSED(memory);
...
/*                                                                       */
FT_CALLBACK_DEF(void *) ft_realloc(FT_Memory memory, FT_Offset cur_size, FT_Offset new_size, void *block)
{
	FT_UNUSED(memory);
	FT_UNUSED(cur_size);
