...
{
	FT_Bytes p = table;
	FT_UInt MathItalicsCorrectionInfo;
	FT_UInt MathTopAccentAttachment;
	FT_UInt ExtendedShapeCoverage;
	FT_UInt MathKernInfo;
...
FT_LOCAL_DEF(void) otv_MATH_validate(FT_Bytes table, FT_UInt glyph_count, FT_Validator ftvalid)
{
	OTV_ValidatorRec otvalidrec;
	OTV_Validator otvalid = &otvalidrec;
	FT_Bytes p = table;
	FT_UInt MathConstants;
	FT_UInt MathGlyphInfo;
	FT_UInt MathVariants;
