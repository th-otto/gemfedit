...
FT_LOCAL_DEF(void) otv_GPOS_subtable_validate(FT_Bytes table, OTV_Validator otvalid)
{
...
FT_LOCAL_DEF(void) otv_GPOS_validate(FT_Bytes table, FT_UInt glyph_count, FT_Validator ftvalid)
{
