 ...
 *  GLYPH DICT SERVICE
 */
static FT_Error t1_get_glyph_name(FT_Face face_, FT_UInt32 glyph_index, FT_Pointer buffer, FT_UInt buffer_max)
{
...
static FT_UInt t1_get_name_index(FT_Face face_, const FT_String *glyph_name)
{
	T1_Face face = (T1_Face) face_;
	FT_Int i;
...
static const char *t1_get_ps_name(FT_Face face_)
{
	T1_Face face = (T1_Face)face_;
...
static const FT_Service_PsFontNameRec t1_service_ps_name = {
	t1_get_ps_name	/* get_ps_font_name */
};
...
static const FT_Service_PsInfoRec t1_service_ps_info = {
	t1_ps_get_font_info,	/* ps_get_font_info    */
	t1_ps_get_font_extra,	/* ps_get_font_extra   */
	t1_ps_has_glyph_names,	/* ps_has_glyph_names  */
	t1_ps_get_font_private,	/* ps_get_font_private */
...
FT_CALLBACK_DEF(FT_Module_Interface) Get_Interface(FT_Module module, const FT_String * t1_interface)
{
	FT_UNUSED(module);
