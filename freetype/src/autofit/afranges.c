...
const AF_Script_UniRangeRec af_adlm_uniranges[] = {
	AF_UNIRANGE_REC(0x1E900UL, 0x1E95FUL),	/* Adlam */
	AF_UNIRANGE_REC(0, 0)
};

const AF_Script_UniRangeRec af_adlm_nonbase_uniranges[] = {
	AF_UNIRANGE_REC(0x1D944UL, 0x1E94AUL),
	AF_UNIRANGE_REC(0, 0)
};
...
const AF_Script_UniRangeRec af_arab_nonbase_uniranges[] = {
	...
	AF_UNIRANGE_REC(0x08D4UL, 0x08E1UL),
...
const AF_Script_UniRangeRec af_buhd_nonbase_uniranges[] = {
	AF_UNIRANGE_REC(0x1752UL, 0x1753UL),
	AF_UNIRANGE_REC(0UL, 0UL)
};


const AF_Script_UniRangeRec af_cakm_uniranges[] = {
	AF_UNIRANGE_REC(0x11100UL, 0x1114FUL),	/* Chakma */
	AF_UNIRANGE_REC(0UL, 0UL)
};

const AF_Script_UniRangeRec af_cakm_nonbase_uniranges[] = {
	AF_UNIRANGE_REC(0x11100UL, 0x11102UL),
	AF_UNIRANGE_REC(0x11127UL, 0x11134UL),
	AF_UNIRANGE_REC(0UL, 0UL)
};


const AF_Script_UniRangeRec af_cans_uniranges[] = {
	AF_UNIRANGE_REC(0x1400UL, 0x167FUL),	/* Unified Canadian Aboriginal Syllabics          */
	AF_UNIRANGE_REC(0x18B0UL, 0x18FFUL),	/* Unified Canadian Aboriginal Syllabics Extended */
	AF_UNIRANGE_REC(0UL, 0UL)
};
...
const AF_Script_UniRangeRec af_cari_uniranges[] = {
	AF_UNIRANGE_REC(0x102A0UL, 0x102DFUL),	/* Carian */
	AF_UNIRANGE_REC(0UL, 0UL)
};
...
const AF_Script_UniRangeRec af_cher_uniranges[] = {
	AF_UNIRANGE_REC(0x13A0UL, 0x13FFUL),	/* Cherokee            */
	AF_UNIRANGE_REC(0xAB70UL, 0xABBFUL),	/* Cherokee Supplement */
	AF_UNIRANGE_REC(0UL, 0UL)
};
...
const AF_Script_UniRangeRec af_copt_uniranges[] = {
	AF_UNIRANGE_REC(0x2C80UL, 0x2CFFUL),	/* Coptic */
	AF_UNIRANGE_REC(0UL, 0UL)
};

const AF_Script_UniRangeRec af_copt_nonbase_uniranges[] = {
	AF_UNIRANGE_REC(0x2CEFUL, 0x2CF1UL),
	AF_UNIRANGE_REC(0UL, 0UL)
};


const AF_Script_UniRangeRec af_cprt_uniranges[] = {
	AF_UNIRANGE_REC(0x10800UL, 0x1083FUL),	/* Cypriot */
	AF_UNIRANGE_REC(0UL, 0UL)
};
...
const AF_Script_UniRangeRec af_cyrl_uniranges[] = {
	...
	AF_UNIRANGE_REC(0x1C80UL, 0x1C8FUL),	/* Cyrillic Extended-C */
	AF_UNIRANGE_REC(0UL, 0)
};
...
const AF_Script_UniRangeRec af_dsrt_uniranges[] = {
	AF_UNIRANGE_REC(0x10400UL, 0x1044FUL),	/* Deseret */
	AF_UNIRANGE_REC(0UL, 0UL)
};
...
const AF_Script_UniRangeRec af_ethi_uniranges[] = {
	AF_UNIRANGE_REC(0x1200UL, 0x137FUL),	/* Ethiopic            */
	AF_UNIRANGE_REC(0x1380UL, 0x139FUL),	/* Ethiopic Supplement */
	AF_UNIRANGE_REC(0x2D80UL, 0x2DDFUL),	/* Ethiopic Extended   */
	AF_UNIRANGE_REC(0xAB00UL, 0xAB2FUL),	/* Ethiopic Extended-A */
	AF_UNIRANGE_REC(0UL, 0UL)
};

const AF_Script_UniRangeRec af_ethi_nonbase_uniranges[] = {
	AF_UNIRANGE_REC(0x135DUL, 0x135FUL),
	AF_UNIRANGE_REC(0UL, 0UL)
};
...
const AF_Script_UniRangeRec af_glag_uniranges[] = {
	AF_UNIRANGE_REC(0x2C00UL, 0x2C5FUL),	/* Glagolitic */
	AF_UNIRANGE_REC(0x1E000UL, 0x1E02FUL),	/* Glagolitic Supplement */
	AF_UNIRANGE_REC(0UL, 0UL)
};

const AF_Script_UniRangeRec af_glag_nonbase_uniranges[] = {
	AF_UNIRANGE_REC(0x1E000UL, 0x1E02FUL),
	AF_UNIRANGE_REC(0UL, 0UL)
};


const AF_Script_UniRangeRec af_goth_uniranges[] = {
	AF_UNIRANGE_REC(0x10330UL, 0x1034FUL),	/* Gothic */
	AF_UNIRANGE_REC(0UL, 0UL)
};
...
const AF_Script_UniRangeRec af_kali_nonbase_uniranges[] = {
	AF_UNIRANGE_REC(0xA926UL, 0xA92DUL),
	AF_UNIRANGE_REC(0UL, 0UL)
};
...
const AF_Script_UniRangeRec af_lisu_uniranges[] = {
	AF_UNIRANGE_REC(0xA4D0UL, 0xA4FFUL),	/* Lisu */
	AF_UNIRANGE_REC(0UL, 0UL)
};
...
const AF_Script_UniRangeRec af_nkoo_uniranges[] = {
	AF_UNIRANGE_REC(0x07C0UL, 0x07FFUL),	/* N'Ko */
	AF_UNIRANGE_REC(0UL, 0UL)
};

const AF_Script_UniRangeRec af_nkoo_nonbase_uniranges[] = {
	AF_UNIRANGE_REC(0x07EBUL, 0x07F5UL),
	AF_UNIRANGE_REC(0UL, 0UL)
};
...
const AF_Script_UniRangeRec af_olck_uniranges[] = {
	AF_UNIRANGE_REC(0x1C50UL, 0x1C7FUL),	/* Ol Chiki */
	AF_UNIRANGE_REC(0UL, 0UL)
};
...
const AF_Script_UniRangeRec af_orkh_uniranges[] = {
	AF_UNIRANGE_REC(0x10C00UL, 0x10C4FUL),	/* Old Turkic */
	AF_UNIRANGE_REC(0UL, 0UL)
};
...
const AF_Script_UniRangeRec af_osge_uniranges[] = {
	AF_UNIRANGE_REC(0x104B0UL, 0x104FFUL),	/* Osage */
	AF_UNIRANGE_REC(0UL, 0UL)
};
...
const AF_Script_UniRangeRec af_osma_uniranges[] = {
	AF_UNIRANGE_REC(0x10480UL, 0x104AFUL),	/* Osmanya */
	AF_UNIRANGE_REC(0UL, 0UL)
};
...
const AF_Script_UniRangeRec af_saur_uniranges[] = {
	AF_UNIRANGE_REC(0xA880UL, 0xA8DFUL),	/* Saurashtra */
	AF_UNIRANGE_REC(0UL, 0UL)
};

const AF_Script_UniRangeRec af_saur_nonbase_uniranges[] = {
	AF_UNIRANGE_REC(0xA880UL, 0xA881UL),
	AF_UNIRANGE_REC(0xA8B4UL, 0xA8C5UL),
	AF_UNIRANGE_REC(0UL, 0UL)
};


const AF_Script_UniRangeRec af_shaw_uniranges[] = {
	AF_UNIRANGE_REC(0x10450UL, 0x1047FUL),	/* Shavian */
	AF_UNIRANGE_REC(0UL, 0UL)
};
...
const AF_Script_UniRangeRec af_tavt_nonbase_uniranges[] = {
	AF_UNIRANGE_REC(0xAAB0UL, 0xAAB0UL),
	AF_UNIRANGE_REC(0xAAB2UL, 0xAAB4UL),
	AF_UNIRANGE_REC(0xAAB7UL, 0xAAB8UL),
	AF_UNIRANGE_REC(0xAABEUL, 0xAABFUL),
	AF_UNIRANGE_REC(0xAAC1UL, 0xAAC1UL),
	AF_UNIRANGE_REC(0UL, 0UL)
};
...
const AF_Script_UniRangeRec af_tfng_uniranges[] = {
	AF_UNIRANGE_REC(0x2D30UL, 0x2D7FUL),	/* Tifinagh */
	AF_UNIRANGE_REC(0UL, 0UL)
};
...
const AF_Script_UniRangeRec af_vaii_uniranges[] = {
	AF_UNIRANGE_REC(0xA500UL, 0xA63FUL),	/* Vai */
	AF_UNIRANGE_REC(0UL, 0UL)
};
