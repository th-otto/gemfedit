...
static FT_Error af_indic_metrics_init(AF_StyleMetrics metrics_, FT_Face face)
{
...
static void af_indic_metrics_scale(AF_StyleMetrics metrics, AF_Scaler scaler)
{
	/* use CJK routines */
...
static FT_Error af_indic_hints_init(AF_GlyphHints hints, AF_StyleMetrics metrics)
{
	/* use CJK routines */
...
static FT_Error af_indic_hints_apply(FT_UInt32 glyph_index, AF_GlyphHints hints, FT_Outline *outline, AF_StyleMetrics metrics)
{
	/* use CJK routines */
...
static void af_indic_get_standard_widths(AF_StyleMetrics metrics_, FT_Pos * stdHW, FT_Pos * stdVW)
{
	AF_CJKMetrics metrics = (AF_CJKMetrics)metrics_;
	if (stdHW)
