...
typedef FT_Error (*AF_WritingSystem_ApplyHintsFunc) (FT_UInt32 glyph_index, AF_GlyphHints hints, FT_Outline *outline, AF_StyleMetrics metrics);
...
#define AF_DEFINE_WRITING_SYSTEM_CLASS(writing_system_class, system, m_size, m_init, m_scale, m_done, m_stdw, h_init, h_apply ) \
  FT_CALLBACK_TABLE_DEF const AF_WritingSystemClassRec  writing_system_class = \
  {                                                      \
    system,                                              \
                                                         \
    m_size,                                              \
...
#define AF_DEFINE_STYLE_CLASS(style_class, style, writing_system, script, blue_stringset, coverage )                    \
  FT_CALLBACK_TABLE_DEF const AF_StyleClassRec  style_class = \
  {                                     \
    style,                              \
    writing_system,                     \
    script,                             \
...
#define AF_DECLARE_WRITING_SYSTEM_CLASS( writing_system_class )            \
  FT_LOCAL( void ) FT_Init_Class_ ## writing_system_class( AF_WritingSystemClassRec*  ac );

#define AF_DEFINE_WRITING_SYSTEM_CLASS(writing_system_class, system, m_size, m_init, m_scale, m_done, m_stdw, h_init, h_apply ) \
  FT_LOCAL_DEF( void ) FT_Init_Class_ ## writing_system_class( AF_WritingSystemClassRec*  ac ) \
  {                                                                       \
...
#define AF_DECLARE_STYLE_CLASS( style_class )             \
  FT_LOCAL( void ) FT_Init_Class_ ## style_class( AF_StyleClassRec*  ac );

#define AF_DEFINE_STYLE_CLASS(style_class, style_, writing_system_, script_, blue_stringset_, coverage_ )                    \
  FT_LOCAL_DEF( void ) FT_Init_Class_ ## style_class( AF_StyleClassRec*  ac ) \
  {                                                      \
    ac->style          = style_;                         \
