...
FT_LOCAL_ARRAY(char *) af_style_names[];
#endif
...
FT_LOCAL(FT_Error) af_face_globals_new(FT_Face face, AF_FaceGlobals * aglobals, AF_Module module);

FT_LOCAL(FT_Error)
af_face_globals_get_metrics(AF_FaceGlobals globals, FT_UInt32 gindex, FT_UInt options, AF_StyleMetrics * ametrics);
