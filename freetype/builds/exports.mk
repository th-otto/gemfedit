...
ifneq ($(EXPORTS_LIST),)
  ...
  CYGPATH:=$(shell if type cygpath >/dev/null 2>&1; then echo cygpath -a -m; else echo echo; fi)
  $(EXPORTS_LIST): $(APINAMES_EXE) $(PUBLIC_HEADERS)
	  $(subst /,$(SEP),$(APINAMES_EXE)) -o$(shell $(CYGPATH) $@) $(APINAMES_OPTIONS) $(shell $(CYGPATH) $(PUBLIC_HEADERS)) || rm -f $@
