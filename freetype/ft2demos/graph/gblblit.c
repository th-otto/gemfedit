...
static void _gblender_blit_dummy(GBlenderBlit blit, GBlenderPixel color)
{
	(void) blit;
	(void) color;
}
...
int gblender_blit_init(GBlenderBlit blit,
				   GBlender blender,
				   int dst_x,
				   int dst_y,
				   ...
				   unsigned char *dst_buffer, int dst_pitch, int dst_width, int dst_height)
{
	int src_x = 0;
	int src_y = 0;
	int delta;
	...
	case GBLENDER_SOURCE_GRAY8:
		switch (dst_format)
		{
		case GBLENDER_TARGET_RGB32:
			blit_func = _gblender_blit_gray8_rgb32;
			break;
		case GBLENDER_TARGET_RGB24:
			blit_func = _gblender_blit_gray8_rgb24;
			break;
		case GBLENDER_TARGET_RGB565:
			blit_func = _gblender_blit_gray8_rgb565;
			break;
		case GBLENDER_TARGET_BGR565:
			blit_func = _gblender_blit_gray8_bgr565;
			break;
		default:
			break;
		}
	...
	case GBLENDER_SOURCE_HRGB:
		...
		{
		case GBLENDER_TARGET_RGB32:
			blit_func = _gblender_blit_hrgb_rgb32;
			break;
		case GBLENDER_TARGET_RGB24:
			blit_func = _gblender_blit_hrgb_rgb24;
			break;
		case GBLENDER_TARGET_RGB565:
			blit_func = _gblender_blit_hrgb_rgb565;
			break;
		case GBLENDER_TARGET_BGR565:
			blit_func = _gblender_blit_hrgb_bgr565;
			break;
		default:
			break;
		}
	...
	case GBLENDER_SOURCE_HBGR:
		...
		{
		case GBLENDER_TARGET_RGB32:
			blit_func = _gblender_blit_hbgr_rgb32;
			break;
		case GBLENDER_TARGET_RGB24:
			blit_func = _gblender_blit_hbgr_rgb24;
			break;
		case GBLENDER_TARGET_RGB565:
			blit_func = _gblender_blit_hbgr_rgb565;
			break;
		case GBLENDER_TARGET_BGR565:
			blit_func = _gblender_blit_hbgr_bgr565;
			break;
		default:
			break;
		}
	...
	case GBLENDER_SOURCE_VRGB:
		...
		{
		case GBLENDER_TARGET_RGB32:
			blit_func = _gblender_blit_vrgb_rgb32;
			break;
		case GBLENDER_TARGET_RGB24:
			blit_func = _gblender_blit_vrgb_rgb24;
			break;
		case GBLENDER_TARGET_RGB565:
			blit_func = _gblender_blit_vrgb_rgb565;
			break;
		case GBLENDER_TARGET_BGR565:
			blit_func = _gblender_blit_vrgb_bgr565;
			break;
		default:
			break;
		}
	...
	case GBLENDER_SOURCE_VBGR:
		...
		{
		case GBLENDER_TARGET_RGB32:
			blit_func = _gblender_blit_vbgr_rgb32;
			break;
		case GBLENDER_TARGET_RGB24:
			blit_func = _gblender_blit_vbgr_rgb24;
			break;
		case GBLENDER_TARGET_RGB565:
			blit_func = _gblender_blit_vbgr_rgb565;
			break;
		case GBLENDER_TARGET_BGR565:
			blit_func = _gblender_blit_vbgr_bgr565;
			break;
		default:
			break;
		}
	...
	case GBLENDER_SOURCE_BGRA:
		...
		{
		case GBLENDER_TARGET_RGB32:
			blit_func = _gblender_blit_bgra_rgb32;
			break;
		case GBLENDER_TARGET_RGB24:
			blit_func = _gblender_blit_bgra_rgb24;
			break;
		case GBLENDER_TARGET_RGB565:
			blit_func = _gblender_blit_bgra_rgb565;
			break;
		case GBLENDER_TARGET_BGR565:
			blit_func = _gblender_blit_bgra_bgr565;
			break;
		default:
			break;
		}
