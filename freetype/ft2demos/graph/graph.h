...
grColor grFindColor(grBitmap *target, int red, int green, int blue, int alpha);
 ...
 *
 **********************************************************************/
void grWriteCellChar(grBitmap *target, int x, int y, int charcode, grColor color);
 ...
 *
 **********************************************************************/
void grWriteCellString(grBitmap *target, int x, int y, const char *string, grColor color);
 ...
 *
 **********************************************************************/
grSurface *grNewSurface(const char *device, grBitmap *bitmap);
