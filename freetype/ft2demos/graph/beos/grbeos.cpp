...
static Translator fkey_translators[] = {
	{B_F1_KEY, grKeyF1},
	{B_F2_KEY, grKeyF2},
	{B_F3_KEY, grKeyF3},
	{B_F4_KEY, grKeyF4},
...
BView(r, "", B_FOLLOW_LEFT_RIGHT, B_WILL_DRAW), _offscreen(offscreen), _event_queue(event_queue), _locker(locker)
{
...
int Window::init_surface(grSurface * surface, grBitmap * bitmap)
{
