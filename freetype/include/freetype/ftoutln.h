...
/*                                                                       */
FT_EXPORT(FT_Error) FT_Outline_New(FT_Library library, FT_UInt numPoints, FT_Int numContours, FT_Outline * anoutline);
...
FT_EXPORT(FT_Error) FT_Outline_Done_Internal(FT_Memory memory, FT_Outline * outline);
