 ...
 *
 */
typedef void *(*FT_Alloc_Func) (FT_Memory memory, FT_Offset size);
 ...
 *
 */
typedef void *(*FT_Realloc_Func) (FT_Memory memory, FT_Offset cur_size, FT_Offset new_size, void *block);
