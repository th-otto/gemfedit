...
typedef FT_Error (*TT_Load_SBit_Image_Func) (TT_Face face,
								FT_ULong strike_index,
								FT_UInt32 glyph_index,
								FT_UInt load_flags, FT_Stream stream, FT_Bitmap * amap, TT_SBit_MetricsRec * ametrics);
...
/*    FreeType error code.  0 means success.                             */
/*                                                                       */
typedef FT_Error(*TT_Get_PS_Name_Func) (TT_Face face, FT_UInt32 idx, FT_String ** PSname);
...
/*                case of error.                                         */
/*                                                                       */
typedef void (*TT_Get_Metrics_Func) (TT_Face face, FT_Bool vertical, FT_UInt32 gindex, FT_Short * abearing, FT_UShort * aadvance);
