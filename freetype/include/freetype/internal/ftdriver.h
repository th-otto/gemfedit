...
typedef FT_Error (*FT_Slot_LoadFunc) (FT_GlyphSlot slot, FT_Size size, FT_UInt32 glyph_index, FT_Int32 load_flags);
...
typedef FT_Error (*FT_Face_GetAdvancesFunc) (FT_Face face, FT_UInt32 first, FT_UInt32 count, FT_Int32 flags, FT_Fixed * advances);
