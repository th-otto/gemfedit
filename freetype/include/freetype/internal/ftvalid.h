...
FT_BASE(void) ft_validator_init(FT_Validator valid, const FT_Byte * base, const FT_Byte * limit, FT_ValidationLevel level);
...
/*                                                                     */
FT_BASE(void) ft_validator_error(FT_Validator valid, FT_Error error);
