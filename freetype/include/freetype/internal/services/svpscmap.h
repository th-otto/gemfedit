 ...
 */
typedef const char *(*PS_GetGlyphNameFunc) (FT_Pointer data, FT_UInt32 string_index);
...
typedef FT_UInt32(*PS_Unicodes_CharIndexFunc) (PS_Unicodes unicodes, FT_UInt32 unicode);
