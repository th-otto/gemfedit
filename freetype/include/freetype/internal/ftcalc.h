 ...
 */
FT_BASE(FT_Int) ft_corner_is_flat(FT_Pos in_x, FT_Pos in_y, FT_Pos out_x, FT_Pos out_y);
...
FT_BASE(FT_Int) FT_MSB(FT_UInt32 z);
...
/*                                                                       */
FT_BASE(FT_Int32) FT_SqrtFixed(FT_Int32 x);
