...
FT_BASE(FT_Pointer) ft_mem_alloc(FT_Memory memory, FT_Offset size, FT_Error * p_error);

FT_BASE(FT_Pointer) ft_mem_qalloc(FT_Memory memory, FT_Offset size, FT_Error * p_error);

FT_BASE(FT_Pointer) ft_mem_realloc(FT_Memory memory, FT_Offset item_size, FT_Offset cur_count, FT_Offset new_count, void *block, FT_Error * p_error);

FT_BASE(FT_Pointer) ft_mem_qrealloc(FT_Memory memory, FT_Offset item_size, FT_Offset cur_count, FT_Offset new_count, void *block, FT_Error * p_error);
...
#define FT_MEM_FREE( ptr ) ft_mem_free( memory, (ptr) ), (ptr) = NULL

#define FT_MEM_NEW( ptr ) FT_MEM_ALLOC( ptr, sizeof ( *(ptr) ) )

#define FT_MEM_REALLOC( ptr, cursz, newsz ) FT_ASSIGNP_INNER( ptr, ft_mem_realloc( memory, 1, (cursz), (newsz), (ptr), &error ) )
...
#define FT_MEM_QREALLOC( ptr, cursz, newsz ) FT_ASSIGNP_INNER( ptr, ft_mem_qrealloc( memory, 1, (cursz), (newsz), (ptr), &error ) )

#define FT_MEM_ALLOC_MULT( ptr, count, item_size ) FT_ASSIGNP_INNER( ptr, ft_mem_realloc( memory, (item_size), 0, (count), NULL, &error ) )

#define FT_MEM_REALLOC_MULT( ptr, oldcnt, newcnt, itmsz ) FT_ASSIGNP_INNER( ptr, ft_mem_realloc( memory, (itmsz), (oldcnt), (newcnt), (ptr), &error ) )

#define FT_MEM_QALLOC_MULT( ptr, count, item_size ) FT_ASSIGNP_INNER( ptr, ft_mem_qrealloc( memory, (item_size), 0, (count), NULL, &error ) )

#define FT_MEM_QREALLOC_MULT( ptr, oldcnt, newcnt, itmsz) FT_ASSIGNP_INNER( ptr, ft_mem_qrealloc( memory, (itmsz), (oldcnt), (newcnt), (ptr), &error ) )
...
FT_BASE(FT_Pointer) ft_mem_dup(FT_Memory memory, const void *address, FT_Offset size, FT_Error * p_error);
...
FT_BASE(FT_Int) ft_mem_strcpyn(char *dst, const char *src, FT_Offset size);
