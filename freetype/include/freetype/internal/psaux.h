...
typedef struct PS_Parser_FuncsRec_
{
	...
	void (*skip_PS_token) (PS_Parser parser);
	 ...
	 FT_Error
		(*to_bytes) (PS_Parser parser, FT_Byte * bytes, FT_Offset max_bytes, FT_ULong * pnum_bytes, FT_Bool delimiters);
	...
	void (*to_token_array) (PS_Parser parser, T1_Token tokens, FT_UInt max_tokens, FT_Int * pnum_tokens);
	 ...
	 FT_Error
		(*load_field) (PS_Parser parser, const T1_Field field, void **objects, FT_UInt max_objects, FT_ULong * pflags);
...
typedef FT_Error(*T1_Decoder_Callback) (T1_Decoder decoder, FT_UInt32 glyph_index);
