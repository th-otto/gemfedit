...
/*    graphics operation.                                                */
/*                                                                       */
FT_EXPORT(FT_Error) FT_Load_Glyph(FT_Face face, FT_UInt32 glyph_index, FT_Int32 load_flags);
...
/*                                                                       */
FT_EXPORT(FT_Error) FT_Get_Glyph_Name(FT_Face face, FT_UInt32 glyph_index, FT_Pointer buffer, FT_UInt buffer_max);
